...
int main (int argc, char** argv)
{
  ...
  t /= times;
  cout << "Time of reducing with c operator [] (averaged for " << times << " runs): " << t << " milliseconds." << endl;
  ...
  cout << "Time of reducing with the on-the-fly address generation - at function (averaged for " << times << " runs): "
      << t << " milliseconds."<< endl;
